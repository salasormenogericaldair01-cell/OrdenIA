...
class MainWindow(QMainWindow):
    def __init__(self, repository: Repository, service: FileService) -> None:
        ...
        self.setWindowTitle("OrdenIA · V0.1")
        ...
        version = QLabel("V0.1 · Local y seguro")
        version.setObjectName("muted")
        version.setAlignment(Qt.AlignmentFlag.AlignCenter)
        side_layout.addWidget(version)
        horizontal.addWidget(sidebar)

        self.pages = [HomePage(repository), FilesPage(repository, service), FoldersPage(repository, service), HistoryPage(repository, service), SettingsPage(repository)]
